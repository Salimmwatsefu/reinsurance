...
from app.models import Claim, ClaimStatus, Prediction as PredictionModel
from app import db
import os
import logging
...
class UploadClaim(Resource):
    def post(self):
        ...
        try:
            ...
            # For now, use mock extraction since OCR dependencies might be heavy
            # In production, you would use: raw_text = process_pdf(file_path)
